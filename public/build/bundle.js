    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "#/");
    			add_location(img, file$5, 11, 16, 273);
    			attr_dev(a0, "href", "#/");
    			...
    			add_location(a1, file$5, 13, 12, 371);
    			attr_dev(span0, "aria-hidden", "true");
    			add_location(span0, file$5, 17, 16, 584);
    			attr_dev(span1, "aria-hidden", "true");
    			add_location(span1, file$5, 18, 16, 633);
    			attr_dev(span2, "aria-hidden", "true");
    			add_location(span2, file$5, 19, 16, 682);
    			attr_dev(a2, "class", "navbar-burger svelte-dgi1rt");
    			attr_dev(a2, "href", "#/");
    			toggle_class(a2, "is-active", /*mobile*/ ctx[0]);
    			add_location(a2, file$5, 16, 12, 486);
