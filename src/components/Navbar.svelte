...
<nav class="navbar is-spaced is-transparent" id="Navbar">
  <div class="container">
    <div class="navbar-brand">
      ...
      <a href="#hero" class="navbar-item is-size-5 has-text-black"> CyDrone </a>
    ...
    <div class="navbar-menu" class:is-active={mobile}>
      <div class="navbar-end">
        <div class="navbar-start">
          <a class="navbar-item has-text-black" href="#About"> O nás </a>
          <a class="navbar-item has-text-black" href="#Partners"> Partneři </a>
          <a class="navbar-item has-text-black" href="#Our_solution"> Naše řešení </a>
          <a class="navbar-item has-text-black" href="#footer"> Kontakt</a>
        </div>
      </div>
    </div>
  </div>
